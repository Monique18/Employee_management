import { query } from "../database/connectToDB.js";
import { createRoleQuery, createEmployeeTableQuery, getAllEmployeeQuery,
    createEmployeeQuery, getEmployeeQuery,  deleteEmployeeQuery, updateEmployeeQuery
 } from "../database/sqlQuery.js";
import { createError } from "../database/error.js";
    ...
    try {
        const response = await query(`
            ...
            res.status(200).json(rows)
                ...
                return next(createError(400,"Could not get employee_details!"));
